...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BakeryUser.date_joined'
        db.add_column(u'auth_bakeryuser', 'date_joined',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BakeryUser.date_joined'
        db.delete_column(u'auth_bakeryuser', 'date_joined')
